...
$pageTitle = 'Content - About Us';
$pageKey = 'content-about';
$assetBase = '../';
...
<main class="admin-content">
    <div class="page-header">
        ...
        <p>Maintain company history, mission, and team highlights.</p>
    </div>
    ...
    <form class="form-card" action="about.php" method="post">
        <div class="form-group">
            <label for="about-intro">Intro Text</label>
            <input id="about-intro" name="intro" type="text" class="form-control" value="<?php echo htmlspecialchars($introValue); ?>" />
        </div>
        <div class="form-group">
            <label for="about-subtitle">Subtitle</label>
            <input id="about-subtitle" name="subtitle" type="text" class="form-control" value="<?php echo htmlspecialchars($subtitleValue); ?>" />
        </div>
        <div class="form-group">
            <label for="about-html">HTML Content</label>
            <textarea id="about-html" name="html" class="form-control" rows="8"><?php echo htmlspecialchars($htmlValue); ?></textarea>
        </div>
